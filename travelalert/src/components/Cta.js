    ...
    <section className="cta-section">
      <div className="container">
        <div className="cta-panel reveal">
          ...
          <a href="#hero" className="btn-primary" style={{ padding: '0.85rem 0.5rem 0.85rem 1.8rem', fontSize: '1rem' }}><span>Scan now</span><span className="icw" style={{ width: '2.4rem', height: '2.4rem' }}><i className="fa-solid fa-arrow-right"></i></span></a>
